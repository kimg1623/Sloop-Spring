            ...
            <div>
                ...
                <form:form modelAttribute="postAssignmentDTO" method="post" onsubmit="return registerAction();"
                    ...
                    <fieldset>
                        ...
                        <span style="font-size:10px; color: #808080;">※ 첨부파일은 개당 25MB, 총 125MB까지 업로드 가능합니다.</span>
                        ...
                        <section class="writeSection">
                            <input type="submit" value="작성하기" class="btn_write"/>
                        </section>
                    </fieldset>
                </form:form>
