    ...
    <div class="container-studyGroup">
        <div class="box-size contents_wrapper">
            ...
            <div>
                ...
                <form:form modelAttribute="postAssignmentDTO" method="post" onsubmit="return registerAction();"
                        ...
                        <div id="articlefileChange">
                            <ul class="list-group">
                                <li class="list-group-item list-group-item-dark">
                                    첨부파일 (${postAssignmentDTO.attachmentDTOList.size()}개)
                                </li>
                                <c:forEach var="attachmentDTO" items="${postAssignmentDTO.attachmentDTOList}" varStatus="fileNum">
                                    <li class="list-group-item">
                                        <div id="file_${fileNum.index}">
                                            <font style="font-size:12px"><c:out
                                                    value="${attachmentDTO.attachmentOrgName}"/> </font>
                                        </div>
                                    </li>
                                </c:forEach>
                            </ul>
