                    ...
                    <div class="box-size">
                        <div id="writeBtn" name="writeBtn">
                            ...
                            <c:if test="${sessionScope.loginEmail != null && postAssignmentDTO.memberEmail == sessionScope.loginEmail}">
                                <input type="button" class="btn_write" onclick="updateFn('${postAssignmentDTO.postIdx}')" value="수정"/>
                                <input type="button" class="btn_write" onclick="deleteFn('${postAssignmentDTO.postIdx}')" value="삭제"/>
                            </c:if>
                        </div>
                    </div>
                </div>
