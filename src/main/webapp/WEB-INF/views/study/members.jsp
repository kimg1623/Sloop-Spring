...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="container-studyGroup">
        <div class="box-size contents_wrapper">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page"
                               href="/study/${StudyGroup.studyGroupCode}/manage/info">스터디 정보</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="/study/${StudyGroup.studyGroupCode}/manage/members">스터디
                                구성원</a>
                        </li>
                    </ul>
                </div>
            ...
            <form:form modelAttribute="StudyGroup" class="form-horizontal" method="post"
                       action="/study/${StudyGroup.studyGroupCode}/manage/info">
                <fieldset>
